...
NPages.nav(ContactListPage).clickSubmit()
...
NPages.nav(ContactListPage).verifyDataDisplayOnField('Name', contact_name)
		.verifyDataDisplayOnField('Birthdate', date_of_birth)
		.verifyDataDisplayOnField('Email', email)
		.verifyDataDisplayOnField('Phone', phone)
		.verifyDataDisplayOnField('Address', street_address_1 + " " + street_address_2)
		.verifyDataDisplayOnField('City, State/Province, Postal Code', city + " " + state_province + " " + postal_code)
