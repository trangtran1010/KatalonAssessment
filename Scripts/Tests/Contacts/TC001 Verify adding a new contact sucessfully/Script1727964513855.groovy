...
NPages.nav(ContactListPage).cleanUpDataTest(contactName)

NPages.takeScreenShot()

'4. Click Add a New Contact button'
NPages.nav(ContactListPage).addNewContact()
...
NPages.nav(ContactListPage).inputAccCate(account_category)
		.checkActive()
